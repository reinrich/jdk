...
// DDD_FF: like DDD but first parameter is a format string
#define DDD_FF_GET_MACRO(_1, _2, _3, NAME, ...) NAME
#define DDD_FF_1(fmt) log_develop_trace(newcode)("DDD %s:%d " fmt, __func__, __LINE__)
//#define DDD_FF_1(a) printf("Format with 1 arg: %s\n" a)
#define DDD_FF_2(fmt, a) log_develop_trace(newcode)("DDD %s:%d " fmt, __func__, __LINE__, a)
#define DDD_FF_3(fmt, a, b) log_develop_trace(newcode)("DDD %s:%d " fmt, __func__, __LINE__, a, b)
// Main macro that dispatches to the right version
#define DDD_FF(...) \
    DDD_FF_GET_MACRO(__VA_ARGS__, DDD_FF_3, DDD_FF_2, DDD_FF_1)(__VA_ARGS__)
